...
tabBtns.forEach(function (element) {
  var tabName = element.getAttribute('data-tab-name');
...
var accordion = document.querySelectorAll('.direction__title-wrapper');
...
if (viewPort <= 600) {
  ...
  accordion.forEach(function (item) {
    item.addEventListener('click', function (e) {
      var description = item.nextElementSibling;
