...
var directionBlock = document.querySelectorAll('.direction');
var accordionTitle = document.querySelectorAll('.direction__title-wrapper');
var accordionContents = document.querySelectorAll('.direction__description');
...
function showContent(item) {
  var description = item.currentTarget.nextElementSibling;
  var parentItem = item.currentTarget.parentElement;
...
if (viewPort <= 600) {
  ...
  directionBlock.forEach(function (block) {
...
var tabBtns = document.querySelectorAll('.tabs__button');
var selectBtn = document.querySelector('.select__placeholder');
var select = document.querySelector('.select');
var mapBlock = document.querySelector('.offices__map');
var tabs = document.querySelector('.tabs');
var cityBtn = document.querySelectorAll('.option__city');
var maps = document.querySelectorAll('.offices__map > img');
var mapPlug = document.querySelector('.offices__map_plug');
var subSelectBtn = document.querySelectorAll('.option__placeholder');
var subSelect = document.querySelectorAll('.option__list');
var mapWrapper = document.querySelector('.offices__map-wrapper');
var plugWrapper = document.querySelector('.plug-wrapper');
subSelectBtn.forEach(function (btn) {
  btn.addEventListener('click', showSubSelect);
});
selectBtn.addEventListener('click', showSelect);
cityBtn.forEach(function (btn) {
...
function showMap(btn) {
  ...
  var tabName = btn.currentTarget.getAttribute('data-tab-name');
  tabBtns.forEach(function (btn) {
...
function showSubSelect(btn) {
  var select = btn.currentTarget.nextElementSibling;
...
function showSelect() {
  subSelect.forEach(function (subSelect) {
...
function getSelectTopValue() {
  var viewPort = document.documentElement.clientWidth;
  var parentPaddingTop = getComputedStyle(select.parentNode).paddingTop.slice(0, -2);
  var hightMenu = getComputedStyle(select.previousElementSibling).height.slice(0, -2);
  var hightTabsBlock = getComputedStyle(document.querySelector('.offices__tabs-wrapper')).height.slice(0, -2);
  var gapInMenuBlock = getComputedStyle(document.querySelector('.offices__menu')).rowGap.slice(0, -2);
  var gapTop = 20;
  if (viewPort > 425) {
    return Number(parentPaddingTop) + Number(hightMenu) + gapTop + 'px';
  }
  return Number(parentPaddingTop) + Number(hightMenu) - hightTabsBlock - gapInMenuBlock + 'px';
}
...
var lodash_clamp = __webpack_require__(7378);
            ...
            get: function () {
                if (!this.hasOwnProperty(key)) {
                    Object.defineProperty(this, key, {
                        value: lodash_debounce_default().apply(void 0, __spreadArrays([fn], options)),
                    });
                }
                return this[key];
            },
...
//# sourceMappingURL=index.js.map
// EXTERNAL MODULE: ./src/offices.js
var offices = __webpack_require__(6915);
...
;// CONCATENATED MODULE: ./src/swiper.js




var swiper = new core('.corporate-life__swiper', {
...
// EXTERNAL MODULE: ./src/directions.js
var directions = __webpack_require__(4500);
